  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 glass border-r border-white/5 z-50 flex flex-col">
      <div className="p-6 border-b border-white/5">
        <h1 className="text-xl font-bold gradient-text">OpportunityAI</h1>
        <p className="text-xs text-dark-500 mt-1">AI-Powered Business Finder</p>
      </div>
      ...
      <nav className="flex-1 p-4 space-y-1">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <span className={isActive ? (item.color || "text-accent-blue") : ""}>
                {item.icon}
              </span>
              {item.label}
              {isActive && (
